...
This documentation tree is organized as a standalone Mintlify project. The public docs use the `CrateStack` brand even though the current implementation workspace in this repo still lives under the historical `cratestack/` name while extraction is in progress.
