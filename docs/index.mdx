...
CoolStack is a Rust-native, schema-first framework for building typed PostgreSQL-backed services from `.cool` files.
...
This documentation tree is organized to be Mintlify-ready and easy to extract later into a standalone public docs site. The current branding still matches the repo name, `CoolStack`.
