...
4. `../guides/offline-first-sqlite` if you want to run the same schema **on-device** against a local SQLite database — same `.cstack` file, sync API, no tokio, designed for Flutter-over-FFI mobile apps
